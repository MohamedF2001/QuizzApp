...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(new Intent(MainActivity.this, QuizzCategory.class), REQUEST_CODE_GAME_ACTIVITY);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (REQUEST_CODE_GAME_ACTIVITY == requestCode && RESULT_OK == resultCode && data != null) {
            ...
            int score = data.getIntExtra(QuizzEconomie.RESULT_SCORE, 0);
    ...
    private void greetUser() {
        ...
        if (firstName != null) {
            if (score != -1) {
                mGreetingTextView.setText(getString(R.string.Introduction, firstName, score));
            } else {
                mGreetingTextView.setText(getString(R.string.Introduction, firstName));
            }
